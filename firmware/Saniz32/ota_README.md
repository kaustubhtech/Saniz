# For Saniz program locally OTA update : -
open cmd
goto saniz32/build
enter command - 
"winpty openssl s_server -WWW -key ca_key.pem -cert ca_cert.pem -port 8070"
very important - make sure the IP of PC (from which uploading) is "192.168.0.105". make adjustments of DHCP setting of router accordingly.
